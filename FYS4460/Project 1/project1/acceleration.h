...
template<typename X, typename V, typename A, typename C> struct Acceleration<X,V,A,Delegate<C,void,A&>> {
...
template<typename X, typename V, typename A, typename C> struct Acceleration<X,V,A,Delegate<C,void,X&,A&>> {
...
template<typename X,typename V, typename A, typename C> struct Acceleration<X,V,A,Delegate<C,void,V&,A&>> {
...
template<typename X,typename V, typename A, typename C> struct Acceleration<X,V,A,Delegate<C,void,X&,V&,A&>> {
