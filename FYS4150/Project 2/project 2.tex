...
\figur{0.8}{tqli.eps}{The normalize solution of the wave function from tqli in lib.cpp for two electrons in a harmonic oscillator well with Coulomb repulsion.}{fig_tqli} 
